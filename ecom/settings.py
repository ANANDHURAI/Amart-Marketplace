...
ALLOWED_HOSTS = ['amart.fun', 'localhost', '127.0.0.1', "amart-e-commerce-website.onrender.com",]
...
# REPLACD YOUR OLD DATABASES SECTION WITH THIS DUE TO RENDER PLOTFORM DOESN'T SUPORT MORE THAN ONE POSTGRESQL DATABASE 
